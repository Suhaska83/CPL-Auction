...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Deep navy stadium background (from screenshots)
        navy: {
          950: "#050b26",
          900: "#0a1338",
          800: "#0f1b4d",
        ...
        // Gold / amber accent (Dhoni Memorial header + values)
        gold: {
          400: "#facc15",
          500: "#eab308",
          600: "#ca8a04"
      ...
      backgroundImage: {
        stadium:
          "radial-gradient(ellipse at top, rgba(37,64,143,0.55) 0%, rgba(5,11,38,0.95) 60%, #050b26 100%)"
      },
      keyframes: {
        "pulse-glow": {
